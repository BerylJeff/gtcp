// Copyright (c) 2021 The Glibevent Authors. All rights reserved.
//
...
import (
	...
	"glibevent/internal/queue"
	"glibevent/pkg/errors"
	"glibevent/pkg/logging"
	"golang.org/x/sys/unix"
)
...
func (p *Poller) OpenPoller() (poller *Poller, err error) {
	poller = new(Poller)
